...
<head>
    ...
    <style>
        ...
        * {
        ...
        .apartado-card:nth-child(1) { animation-delay: 0.1s; }
        .apartado-card:nth-child(2) { animation-delay: 0.2s; }
        .apartado-card:nth-child(3) { animation-delay: 0.3s; }
        .apartado-card:nth-child(4) { animation-delay: 0.4s; }
    ...
    <nav class="navbar-desktop">
        <div class="navbar-desktop-container">
            ...
            <div class="nav-links">
                ...
                <a href="#"  class="active"><i class="fas fa-calendar-check"></i> Apartados</a>
                <a href="ventas.html"><i class="fas fa-history"></i> Ventas</a>
        ...
        <div class="cards-grid">
            ...
            <div class="apartado-card">
                ...
                <div class="card-body">
                    ...
                    <a href="detallesApartado.html" class="details-link">
